...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2022-11-30T11:46:00Z"), u1);
		Order o2 = new Order(null, Instant.parse("2022-11-21T08:46:02Z"), u2);
		Order o3 = new Order(null, Instant.parse("2022-11-12T09:50:09Z"), u1);
